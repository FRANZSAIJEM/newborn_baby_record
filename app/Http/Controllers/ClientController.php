...
class ClientController extends Controller
{
    ...
    public function update(Client $client, Request $request)
    {
        ...
        return redirect('/clients/' . $client->id)->with('info', 'A new Baby has been updated');
    }


    public function destroy(Client $client) {
        $client->delete();
        return redirect('/clients')->with('error', 'A new Baby has been deleted');
    }
    ...
    public function store(Request $request) {
        ...
        return redirect('/clients/' . $c->id)->with('info', 'A new Baby has been created');
    }
